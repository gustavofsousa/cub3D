...
{
	if (data->key.w_is_press || data->key.s_is_press
		|| data->key.d_is_press || data->key.a_is_press)
	{
		render_map3d(data);
...
void	render_game(t_data *data)
{
	...
	mlx_hook(data->img.mlx_win, 17, 0, close_window, data);
